...
Gem::Specification.new do |spec|
  spec.name          = 'versioned_database_functions'
  spec.version       = VersionedDatabaseFunctions::VERSION
  ...
  spec.description   = <<-DESCRIPTION
    ...
    in Rails
  DESCRIPTION
  spec.homepage      = 'https://github.com/thoughtbot/versioned_database_functions'
  spec.license       = 'MIT'
