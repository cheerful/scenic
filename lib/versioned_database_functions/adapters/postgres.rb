...
module VersionedDatabaseFunctions
  ...
  module Adapters
    ...
    # {VersionedDatabaseFunctions.database}.
    #
    ...
    class Postgres
      ...
      #
      # This collection of views is used by the [VersionedDatabaseFunctions::SchemaDumper] to
      # populate the `schema.rb` file.
      #
      # @return [Array<VersionedDatabaseFunctions::View>]
      def views
      ...
      #
      # This is typically called from application code via {VersionedDatabaseFunctions.database}.
      #
      ...
      #   VersionedDatabaseFunctions.database.refresh_materialized_view(:search_results)
      # @example Concurrent refresh
      #   VersionedDatabaseFunctions.database.refresh_materialized_view(:posts, concurrently: true)
      #
      # @return [void]
