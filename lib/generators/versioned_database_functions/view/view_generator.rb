...
require "generators/versioned_database_functions/materializable"
...
module VersionedDatabaseFunctions
  module Generators
    ...
    class ViewGenerator < Rails::Generators::NamedBase
      ...
      include VersionedDatabaseFunctions::Generators::Materializable
      ...
      def definition
        VersionedDatabaseFunctions::Definition.new(plural_file_name, version)
      end

      def previous_definition
        VersionedDatabaseFunctions::Definition.new(plural_file_name, previous_version)
      end
