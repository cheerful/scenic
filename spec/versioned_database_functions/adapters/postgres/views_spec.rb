...
module VersionedDatabaseFunctions
  module Adapters
    describe Postgres::Views, :db do
      it "returns versioned_database_functions view objects for plain old views" do
      ...
      it "returns versioned_database_functions view objects for materialized views" do
        connection = ActiveRecord::Base.connection
        connection.execute <<-SQL
